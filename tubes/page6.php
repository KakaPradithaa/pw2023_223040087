<!doctype html>
    ...
    <div class="container">
        <nav aria-label="breadcrumb" style="background-color: #fff;" class="mt-3">
            <ol class="breadcrumb p-3">
                ...
                <li class="breadcrumb-item active" aria-current="page">Tempat Wisata & Rekreyasi</li>
            </ol>
        </nav>
    </div>
    <!--Breadcrumb-->
    ...
    <div class="container">
        <div class="row row-pemkot">
            <div class="col-lg-5">
                <figure class="figure">
                    <img src="kategori/6.jpg" class="figure-img img-fluid" style="border-radius: 5px;" width="450px">
            </div>
            <div class="col-lg-7">
                <h4 style="color:  #0d6efd;">Tempat Wisata & Rekreyasi</h4>
                ...
                <div>
                    <span class="figure-caption d-flex justify-content-evenly fw-bold">
                        ...
                        <br> <br>
                        Kota Bandung adalah salah satu kota terbesar yang ada di Indonesia. Kota ini juga dijuluki sebagai “Paris Van Java” atau kota Paris-nya Jawa. Karena semua hal ada di Bandung. Kota ini juga memiliki tata kota yang apik dan fasilitas yang memadai untuk para pelancong, baik yang berasal dari dalam negeri maupun wisatawan luar negeri.
                        <br> <br>
