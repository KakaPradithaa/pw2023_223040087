<!doctype html>
    ...
    <div class="container">
        <nav aria-label="breadcrumb" style="background-color: #fff;" class="mt-3">
            <ol class="breadcrumb p-3">
                ...
                <li class="breadcrumb-item active" aria-current="page">Profil Pemimpin</li>
            </ol>
        </nav>
    </div>
    <!--Breadcrumb-->
    ...
    <div class="container">
        <div class="row row-pemkot">
            <div class="col-lg-5">
                <figure class="figure">
                    <img src="aset/wallkot.jpeg" class="figure-img img-fluid" style="border-radius: 5px;" width="450px">
                </div>
            <div class="col-lg-7">
                <h4 style="color:  #0d6efd;">Profil Pemimpin</h4>
                <div class="garis-item">
                    </div>
                    <div>
                    <span class="figure-caption d-flex justify-content-evenly fw-bold">
                        Yana Mulyana, S.E., M.M. (lahir 17 Februari 1965) adalah seorang pengusaha dan politikus berkebangsaan Indonesia. Dia pernah menjabat sebagai Wali Kota Bandung menggantikan Oded Muhammad Danial yang meninggal dunia pada 2021 untuk sisa masa jabatan 2018–2023.[2] Masa jabatannya berakhir setelah ditetapkan menjadi tersangka kasus korupsi oleh Komisi Pemberantasan Korupsi Republik Indonesia (KPK RI)
                    </span>
                </div>
                </div>
            </div>
