    ...
    <div class="container">
        <nav aria-label="breadcrumb" style="background-color: #fff;" class="mt-3">
            <ol class="breadcrumb p-3">
                ...
                <li class="breadcrumb-item active" aria-current="page">Pendidikan & Kebudayaan</li>
            </ol>
        </nav>
    </div>
<!--Breadcrumb-->
...
<!--Singleitem-->
    <div class="container">
        <div class="row row-pemkot">
            <div class="col-lg-5">
                <figure class="figure">
                    <img src="kategori/7.jpg" class="figure-img img-fluid" style="border-radius: 5px;" width="450px">
                    <img src="kategori/4.jpg" class="figure-img img-fluid mt-5" style="border-radius: 5px;" width="450px">
            </div>
            <div class="col-lg-7">
                <h4 style="color:  #0d6efd;">Pendidikan & Kebudayaan</h4>
                ...
                <div>
                    <span class="figure-caption d-flex justify-content-evenly fw-bold">
                        ...
                        Optimalisasi infrastruktur dan penataan ruang
                        ...
                        <br> <br>
                        Selain dikenal sebagai Paris Van Java dan Kota Kembang, Bandung pun dijuluki The Most European City in The East Indies, Bandung Excelsior, Intelectuele Centrum Van Indie, Europe in The Tropen, Kota Permai, Kota Pendidkan, Kota Kreatif hingga Kota Kuliner.
                        <br><br>
                    </span>
                </div>
                </div>
