...
<!--Singleitem-->
    <div class="container">
        <div class="row row-pemkot">
            <div class="col-lg-5">
                <figure class="figure">
                    <img src="../aset/s2.jpeg" class="figure-img img-fluid" style="border-radius: 5px;" width="450px">
            </div>
            <div class="col-lg-7">
                <h4 style="color:  #0d6efd;">Kota Bandung Siap Sambut PPDB 2023/24</h4>
                <div class="garis-item">
                </div>
                <div>
                    <span class="figure-caption d-flex justify-content-evenly fw-bold">
                    Bandung, WWW.PASJABAR.COM – Pemerintah Kota Bandung siap menyambut Pendaftaran Peserta Didik Baru (PPDB) tahun ajaran 2023/24. Hal itu disampaikan Ketua Tim PPDB Kota Bandung Edy Suparjoto dalam Bandung Menjawab, Kamis 25 Mei 2023.
                    <br><br>
