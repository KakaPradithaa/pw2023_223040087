...
<!--Etalase-->
        <div class="container mt-5">
            <div class="judul-kategori" style="background-color: #fff; padding: 5px 10px;">
                <h5 class="text-center" style="margin-top: 5px;">FITUR</h5>
            </div>
            <div class="row text-center row-container mt-2">
                <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="menu-kategori">
                        <a href="fiturpage/fitur1.php"><img src="fitur/3.jpeg" alt="" class="image-categori mt-3"></a>
                        <p class="mt-3">Makanan Khas Bandung</p>
                    </div>
                </div>

                <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="menu-kategori">
                        <a href="fiturpage/fitur2.php"><img src="fitur/4.jpeg" alt="" class="image-categori mt-3"></a>
                        <p class="mt-3">Seni dan Budaya</p>
                    </div>
                </div>           

                <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="menu-kategori">
                        <a href="fiturpage/fitur3.php"><img src="fitur/5.jpeg" alt="" class="image-categori mt-3"></a>
                        <p class="mt-3">Hiburan</p>
                    </div>
                </div>

                <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="menu-kategori">
                        <a href="fiturpage/fitur4.php"><img src="fitur/6.jpg" alt="" class="image-categori mt-3"></a>
                        <p class="mt-3">Arsitektur</p>
                    </div>
                </div>

                <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="menu-kategori">
                        <a href="fiturpage/fitur5.php"><img src="fitur/7.jpeg" alt="" class="image-categori mt-3"></a>
                        <p class="mt-3">Alam</p>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                    <div class="menu-kategori">
                        <a href="fiturpage/fitur6.php"><img src="fitur/8.jpeg" alt="" class="image-categori mt-3"></a>
                        <p class="mt-3">Letak Geografis</p>
                    </div>
                </div>
            </div>
        </div> 
