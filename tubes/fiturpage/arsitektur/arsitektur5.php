    ...
    <div class="container">
        <nav aria-label="breadcrumb" style="background-color: #fff;" class="mt-3">
            <ol class="breadcrumb p-3">
                ...
                <li class="breadcrumb-item"><a href="../fitur4.phpl" class="text-decoration-none">Arsitektur</a></li>
                <li class="breadcrumb-item active" aria-current="page">Jembatan Pasupati</li>
            </ol>
        </nav>
    </div>
<!--Breadcrumb-->
...
<!--Singleitem-->
    <div class="container">
        <div class="row row-pemkot">
            ...
            <div class="col-lg-7">
                <h4 style="color:  #0d6efd;">Jembatan Pasupati</h4>
                <div class="garis-item">
                </div>
            <div>
                    <span class="figure-caption d-flex justify-content-evenly fw-bold">
                        Jembatan Pasupati juga dikenal sebagai Jalan Layang Pasupati. Nama jembatan yang telah beroperasi sejak tahun 2005 ini diambil dari 2 nama jalan yang dihubungkan, yaitu Pasteur dan Surapati.
                        <br><br>
                        Selain menjadi ikon Kota Bandung, Jembatan Pasupati juga menjadi jembatan terpanjang ke-2 di Indonesia setelah Jembatan Suramadu yang berada di Kota Madura. Jembatan Pasupati memiliki panjang sekitar 2,8 kilometer dan lebar sekitar 21,53 meter.
                        <br><br>
                        Keunikan dari Jembatan Pasupati terletak pada bagian tengahnya, yaitu terdapat satu tiang yang cukup tinggi dan ditopang dengan 19 cable stayed. Selain itu, jembatan ini juga menggunakan teknologi Look Up Device (LUD). Teknologi ini merupakan perangkat khusus tahan gempa buatan Prancis. Jembatan Pasupati adalah jembatan pertama di Indonesia yang menggunakan teknologi LUD sehingga menjadikannya sebagai jembatan tahan gempa pertama di Indonesia.
                    </span>
            </div>
                </div>
            </div>
