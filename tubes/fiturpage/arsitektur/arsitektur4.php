    ...
    <div class="container">
        <nav aria-label="breadcrumb" style="background-color: #fff;" class="mt-3">
            <ol class="breadcrumb p-3">
                ...
                <li class="breadcrumb-item active" aria-current="page">Balai Kota Bandung</li>
            </ol>
        </nav>
    </div>
<!--Breadcrumb-->
...
<!--Singleitem-->
    <div class="container">
        <div class="row row-pemkot">
            <div class="col-lg-5">
                <figure class="figure">
                    <img src="4.jpeg" class="figure-img img-fluid" style="border-radius: 5px;" width="450px">
            </div>
            <div class="col-lg-7">
                <h4 style="color:  #0d6efd;">Balai Kota Bandung</h4>
                <div class="garis-item">
                </div>
            <div>
                    <span class="figure-caption d-flex justify-content-evenly fw-bold">
                        Di Jln. Wastukancana No. 2 Bandung terdapat komplek perkantoran pemerintahan Kota Bandung, Balai Kota Bandung dahulu bernama Gedung Kopi (Koffie Pakhuis). Bangunan ini merupakan gudang penyimpanan hasil bumi, dan tempat pengepakan kopi milik Andries de Wilde. Ia adalah seorang tuan tanah pertama di daerah Priangan.
                        <br><br>
                        Selain Komplek Perkantoran Pemerintahan Kota Bandung, Balaikota Bandung juga digunakan untuk wisata warga Kota Bandung maupun wisatawan dari luar Kota Bandung.
                    </span>
            </div>
                </div>
            </div>
