    ...
    <div class="container">
        <nav aria-label="breadcrumb" style="background-color: #fff;" class="mt-3">
            <ol class="breadcrumb p-3">
                ...
                <li class="breadcrumb-item active" aria-current="page">Lembang Park Zoo</li>
            </ol>
        </nav>
    </div>
<!--Breadcrumb-->
...
<!--Singleitem-->
    <div class="container">
        <div class="row row-pemkot">
            <div class="col-lg-5">
                <figure class="figure">
                    <img src="6.jpg" class="figure-img img-fluid" style="border-radius: 5px;" width="450px">
            </div>
            <div class="col-lg-7">
                <h4 style="color:  #0d6efd;">Lembang Park Zoo</h4>
                <div class="garis-item">
                </div>
            <div>
                    <span class="figure-caption d-flex justify-content-evenly fw-bold">
                        Lembang Park & Zoo berdiri di atas tanah seluas 25 hektar di Kawasan Bandung Barat yang berudara sejuk. Dengan mengusung tema Bavarian yang matang dan mengutamakan kenyamanan bagi pengunjung dan satwa yang ada, menjadikan Lembang Park & Zoo sebagai destinasi eduwisata bagi keluarga yang memungkinkan wisatawan bermain ditaman sambil menambah ilmu pengetahuan dan berinteraksi secara langsung dengan beragam satwa eksotis. Konsep unik dengan tampilan arsitektur yang modern dan fasilitas berkualitas tinggi yang ditawarkan merupakan keunggulan dari Lembang Park&Zoo. Saat ini Lembang Park & Zoo setidaknya memiliki 350 ekor binatang diantaranya berbagai jenis pisces, reptilia, aves, dan mamalia.
                    </span>
            </div>
                </div>
            </div>
