    ...
    <div class="container">
        <nav aria-label="breadcrumb" style="background-color: #fff;" class="mt-3">
            <ol class="breadcrumb p-3">
                ...
                <li class="breadcrumb-item active" aria-current="page">Museum Geologi Bandung</li>
            </ol>
        </nav>
    </div>
<!--Breadcrumb-->
...
<!--Singleitem-->
    <div class="container">
        <div class="row row-pemkot">
            <div class="col-lg-5">
                <figure class="figure">
                    <img src="3.jpg" class="figure-img img-fluid" style="border-radius: 5px;" width="450px">
            </div>
            <div class="col-lg-7">
                <h4 style="color:  #0d6efd;">Museum Geologi Bandung</h4>
            ...
            <div>
                    <span class="figure-caption d-flex justify-content-evenly fw-bold">
                        ...
                        <br><br>
                        Museum ini memiliki koleksi berupa materi-materi geologi, mulai dari fosir, batuan, hingga mineral. Semua koleksi dan materi geologi di dalam museum ini merupakan hasil dari pengumpulan selama kerja lapangan di Indonesia sejak tahun 1850.
                        <br><br>
                        Museum geologi di desain oleh seorang insinyur bernama IR. Menalda Van Schouwenburg dan di banguan lim A Goh. Bangunan memiliki konsep bangunan dengan gaya arsitektur 'art deco” dengan menggunakan campuran unsur dekoratif kuno dan fitur arsitektur modern pada abad 19.
                        <br><br>
                    </span>
            </div>
                </div>
