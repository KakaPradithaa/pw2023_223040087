<!doctype html>
    ...
    <div class="container">
        <nav aria-label="breadcrumb" style="background-color: #fff;" class="mt-3">
            <ol class="breadcrumb p-3">
                ...
                <li class="breadcrumb-item active" aria-current="page">Kuda Renggong</li>
            </ol>
        </nav>
    </div>
    <!--Breadcrumb-->
    ...
    <div class="container">
        <div class="row row-pemkot">
            ...
            <div class="col-lg-7">
                <h4 style="color:  #0d6efd;">Kuda Renggong</h4>
                <div class="garis-item">
                </div>
            <div>
                    <span class="figure-caption d-flex justify-content-evenly fw-bold">
                    Kuda Renggong adalah salah satu seni pertunjukan helaran yang berasal dari Kabupaten Sumedang. Kata renggong merupakan metatesis dari kata ronggeng yang berarti kamonesan (keterampilan) cara berjalan kuda yang dilatih menari dan mengikuti irama musik yang didominasi oleh kendang.Kesenian ini sering dijadikan hiburan arak-arakan anak khitanan atau sunat, menerima tamu kehormatan, perayaan hari besar, dan pengisi acara dalam helaran atau festival.
                    <br><br> 
