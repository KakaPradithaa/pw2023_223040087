...
<!--Navbar-->    
        <nav class="navbar">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../../fiturpage.hphp">Fitur</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        <nav aria-label="breadcrumb" style="background-color: #fff;" class="mt-3">
            <ol class="breadcrumb p-3">
                ...
                <li class="breadcrumb-item active" aria-current="page">Wayang Golek</li>
            </ol>
        </nav>
    </div>
<!--Breadcrumb-->
...
<!--Singleitem-->
    <div class="container">
        <div class="row row-pemkot">
            <div class="col-lg-5">
                <figure class="figure">
                    <img src="2.jpeg" class="figure-img img-fluid" style="border-radius: 5px;" width="450px">
            </div>
            <div class="col-lg-7">
                <h4 style="color:  #0d6efd;">Wayang Golek</h4>
