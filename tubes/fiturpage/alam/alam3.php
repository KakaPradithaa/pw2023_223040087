    ...
    <div class="container">
        <nav aria-label="breadcrumb" style="background-color: #fff;" class="mt-3">
            <ol class="breadcrumb p-3">
                ...
                <li class="breadcrumb-item active" aria-current="page">Forest Walk Babakan Siliwangi</li>
            </ol>
        </nav>
    </div>
<!--Breadcrumb-->
...
<!--Singleitem-->
    <div class="container">
        <div class="row row-pemkot">
            ...
            <div class="col-lg-7">
                <h4 style="color:  #0d6efd;">Forest Walk Babakan Siliwangi</h4>
                <div class="garis-item">
                </div>
            <div>
                    <span class="figure-caption d-flex justify-content-evenly fw-bold">
                        Kota Bandung hanya sedikit mempunyai tenmpat wisata alam. Salah satunya Taman Kota Babakan Siliwangi.
                        <br><br>
                        Bagi mereka yang ingin dekat dengan alam, tetapi enggan pergi jauh-jauh dari Kota Bandung, tempat wisata ini menjadi pilihan yang tepat.
                        <br><br>
                        ...
                        <br><br>
                        Taman Kota Babakan Siliwangi menjadi piliuhan tepat bagi Anda yang ingin berwisata dengan murah namun sehat.*humas.bandung.go.id*
                        <br><br>
                    </span>
            </div>
                </div>
