...
<!--Breadcrumb-->
        <div class="container">
            <nav aria-label="breadcrumb" style="background-color: #fff;" class="mt-3">
                ...
                <li class="breadcrumb-item active" aria-current="page">Alam</li>
                </ol>
            </nav>
        </div>
<!--Breadcrumb-->
...
<!--Makanan khas-->
        <div class="container mt-5">
            <div class="judul-artikel" style="background-color: #fff; padding: 5px 10px;">
                <h5 class="text-center" style="margin-top: 5px;">Alam</h5>
            <div class="row">
                <div class="col-lg-2 col-md-2 col-sm-4 col-6 mt-2">
                    <div class="card text-center">
                        <img src="alam/1.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h6 class="card-title">'Serlok Bantaran', Kawasan Konservasi Bambu di Bandung</h6>
                        <a href="alam/alam1.php" class="btn btn-primary">Lihat Detail</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-4 col-6 mt-2">
                    <div class="card text-center">
                        <img src="alam/2.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h6 class="card-title">Sekemala Integrated Farming</h6>
                        <a href="alam/alam2.php" class="btn btn-primary">Lihat Detail</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-4 col-6 mt-2">
                    <div class="card text-center">
                        <img src="alam/3.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h6 class="card-title">Forest Walk Babakan Siliwangi</h6>
                        <a href="alam/alam3.php" class="btn btn-primary">Lihat Detail</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-4 col-6 mt-2">
                    <div class="card text-center">
                        <img src="alam/4.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h6 class="card-title">Wetland Park Cisurupan</h6>
                        <a href="alam/alam4.php" class="btn btn-primary">Lihat Detail</a>
                        </div>
                    </div>
                </div>
            </div>
