   ...
   <!--Breadcrumb-->
        <div class="container">
            <nav aria-label="breadcrumb" style="background-color: #fff;" class="mt-3">
                ...
                <li class="breadcrumb-item active" aria-current="page">Makanan Khas Bandung</li>
                </ol>
            </nav>
        </div>
    <!--Breadcrumb-->
    ...
    <!--Makanan khas-->
        <div class="container mt-5">
            <div class="judul-artikel" style="background-color: #fff; padding: 5px 10px;">
                <h5 class="text-center" style="margin-top: 5px;">Makanan Khas Bandung</h5>
            <div class="row">
                <div class="col-lg-2 col-md-2 col-sm-4 col-6 mt-2">
                    <div class="card text-center">
                        <img src="../fitur/1.jpeg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h6 class="card-title">Mie Kocok</h6>
                        <a href="makananpage/makanan1.php" class="btn btn-primary">Lihat Detail</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-4 col-6 mt-2">
                    <div class="card text-center">
                        <img src="../fitur/9.jpeg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h6 class="card-title">Surabi Oncom</h6>
                        <a href="makananpage/makanan2.php" class="btn btn-primary">Lihat Detail</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-4 col-6 mt-2">
                    <div class="card text-center">
                        <img src="../fitur/10.jpeg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h6 class="card-title">Batagor</h6>
                        <a href="makananpage/makanan3.php" class="btn btn-primary">Lihat Detail</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-4 col-6 mt-2">
                    <div class="card text-center">
                        <img src="../fitur/11.jpeg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h6 class="card-title">Seblak</h6>
                        <a href="makananpage/makanan4.php" class="btn btn-primary">Lihat Detail</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-4 col-6 mt-2">
                    <div class="card text-center">
                        <img src="../fitur/12.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h6 class="card-title">Lotek</h6>
                        <a href="makananpage/makanan5.php" class="btn btn-primary">Lihat Detail</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-4 col-6 mt-2">
                    <div class="card text-center">
                        <img src="../fitur/2.jpeg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h6 class="card-title">Peyeum</h6>
                        <a href="makananpage/makanan6.php" class="btn btn-primary">Lihat Detail</a>
                        </div>
                    </div>
                </div>
            </div>
