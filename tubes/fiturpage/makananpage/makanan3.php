<!doctype html>
    ...
    <div class="container">
        <nav aria-label="breadcrumb" style="background-color: #fff;" class="mt-3">
            <ol class="breadcrumb p-3">
                ...
                <li class="breadcrumb-item active" aria-current="page">Batagor</li>
            </ol>
        </nav>
    </div>
    <!--Breadcrumb-->
    ...
    <div class="container">
        <div class="row row-pemkot">
            <div class="col-lg-5">
                <figure class="figure">
                    <img src="../../fitur/10.jpeg" class="figure-img img-fluid" style="border-radius: 5px;" width="450px">
            </div>
            <div class="col-lg-7">
                <h4 style="color:  #0d6efd;">Batagor</h4>
                <div class="garis-item">
                  </div>
                  <div>
                    <span class="figure-caption d-flex justify-content-evenly fw-bold">
                        Batagor merupakan jajanan khas Bandung yang kini sudah dikenal hampir di seluruh wilayah Indonesia.
                        <br><br>
                        ...
                        <br><br>
                        Batagor mulai muncul di berbagai kota di Indonesia pada tahun 1980-an, dan diyakini pertama kali dibuat pada tahun 1968 di Bandung.[4] Menurut sebuah kisah, batagor pertama kali dibuat untuk menyelamatkan bakso-bakso yang tidak laku. Konon suatu hari seorang pedagang bakso tidak laku, dan penjualnya memiliki sisa bakso yang terlalu banyak. Untuk mengurangi kerugiannya, dia kemudian memiliki ide untuk menggiling bakso, memasukkannya ke dalam tahu, menggorengnya, dan menyajikannya dengan sambal kacang seperti siomay atau ngo hiang. Ide ini kemudian menciptakan hidangan baru bakso tahu goreng ("bakso goreng [dan] tahu"), disingkat "batagor".
                    </span>
                  </div>
                </div>
            </div>
