<!doctype html>
    ...
    <!--Navbar-->    
        <nav class="navbar">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="../../index.phpl">Beranda</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        <nav aria-label="breadcrumb" style="background-color: #fff;" class="mt-3">
            <ol class="breadcrumb p-3">
                ...
                <li class="breadcrumb-item"><a href="../fitur1.php" class="text-decoration-none">Makanan Khas Bandung</a></li>
                <li class="breadcrumb-item active" aria-current="page">Mie Kocok</li>
            </ol>
        </nav>
    </div>
    <!--Breadcrumb-->
    ...
    <div class="container">
        <div class="row row-pemkot">
            <div class="col-lg-5">
                <figure class="figure">
                    <img src="../../fitur/1.jpeg" class="figure-img img-fluid" style="border-radius: 5px;" width="450px">
            </div>
            <div class="col-lg-7">
                <h4 style="color:  #0d6efd;">Mie Kocok</h4>
                ...
                <div>
                    <span class="figure-caption d-flex justify-content-evenly fw-bold">
                        Mie Kocok
                        <br><br>
                        Hidangan ini terdiri atas mie kuning yang disajikan dalam kuah kaldu sapi kental, irisan kikil (tendon kaki sapi), taoge, bakso, jeruk nipis, dan ditaburi irisan seledri adalah makanan favorit lintas generasi
                        <br><br>
                        Mie kocok merupakan kuliner lintas generasi karena bisa dinikmati oleh siapapun, baik anak-anak hingga orang tua. Meski penjualnya ditemukan di berbagai daerah, mie kocok berasal dari Bandung, Jawa Barat. Istilah kocok dalam nama hidangan ini merujuk kepada proses memasaknya, yaitu mengocok-ngocok mi dalam wadah logam bolong-bolong bergagang, seraya mencelupkannya ke dalam air panas. Jenis mi yang digunakan adalah mi kuning gepeng yang bertekstur lebih lembut.
                        <br><br>
                        Hidangan ini terdiri atas mie kuning yang disajikan dalam kuah kaldu sapi kental, irisan kikil (tendon kaki sapi), taoge, bakso, jeruk nipis, dan ditaburi irisan seledri, daun bawang, dan bawang goreng. Beberapa resep mungkin menambahkan babat sapi.
                    </span>
                  </div>
                </div>
            </div>
