    ...
    <!--Makanan khas-->
        <div class="container mt-5">
            <div class="judul-artikel" style="background-color: #fff; padding: 5px 10px;">
                <h5 class="text-center" style="margin-top: 5px;">Hiburan</h5>
            <div class="row">
                <div class="col-lg-2 col-md-2 col-sm-4 col-6 mt-2">
                    <div class="card text-center">
                        <img src="hiburan/1.jpeg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h6 class="card-title">Saung Angklung Udjo</h6>
                        <a href="hiburan/hiburan1.php" class="btn btn-primary">Lihat Detail</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-4 col-6 mt-2">
                    <div class="card text-center">
                        <img src="hiburan/2.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h6 class="card-title">The Great Asia Afrika</h6>
                        <a href="hiburan/hiburan2.php" class="btn btn-primary">Lihat Detail</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-4 col-6 mt-2">
                    <div class="card text-center">
                        <img src="hiburan/3.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h6 class="card-title">Museum Geologi Bandung</h6>
                        <a href="hiburan/hiburan3.php" class="btn btn-primary">Lihat Detail</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-4 col-6 mt-2">
                    <div class="card text-center">
                        <img src="hiburan/4.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h6 class="card-title">Taman Hutan Raya Juanda</h6>
                        <a href="hiburan/hiburan4.php" class="btn btn-primary">Lihat Detail</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-4 col-6 mt-2">
                    <div class="card text-center">
                        <img src="hiburan/5.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h6 class="card-title">Dago Dream Park</h6>
                        <a href="hiburan/hiburan5.php" class="btn btn-primary">Lihat Detail</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-4 col-6 mt-2">
                    <div class="card text-center">
                        <img src="hiburan/6.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <h6 class="card-title">Lembang Park Zoo</h6>
                        <a href="hiburan/hiburan6.php" class="btn btn-primary">Lihat Detail</a>
                        </div>
                    </div>
                </div>
            </div>
